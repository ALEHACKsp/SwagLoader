...
namespace WindowsFormsApp2
{
    public partial class Form1 : Form
    {
        ...
        private void button2_Click_1(object sender, EventArgs e)
        {
                ...
                dl.DownloadFile("https://github.com/doonayy/FlexLoader/raw/main/miscs/nSkinz.dll", mainpath); //Replace "DLL URL" with the URL to directly download your DLL [Example: http://myurl.com/MYDLL.dll]
